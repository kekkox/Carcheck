      ...
      <div class="signup_container">
        ...
        <form action="" method="post">
          ...
          <div class = "inputBox" id = "piva">
            <input type="text" name="iva" value ="" onkeyup="this.setAttribute('value', this.value);" pattern ="^[0-9]{11}$" required>
            <label>Partita Iva</label>
          </div>
    	
    	  <div class = "inputBox" id = "businessName">
		      <input type="text" name="businessName" value ="" onkeyup="this.setAttribute('value', this.value);" required>
    	  ...
    	  <div class = "inputBox" id = "telephone">
            <input type="tel" name="telephone" value ="" onkeyup="this.setAttribute('value', this.value);" pattern="^[0-9]{8,14}$" required>
