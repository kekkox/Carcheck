...
class StatementFactory {
	 ...
	 */
	public <T> PreparedStatement createStatement(StatementType statementType, Connection connection, IBeanEntity<T> beanEntity, String sql) throws SQLException, Exception {
		...
		if(statementType == StatementType.Create)
			...
			return getReadStatement(connection, sql);
	 ...
	 * @throws SQLException Exception generated by the Java.sql library
	 */
	private <T> PreparedStatement getReadStatement(Connection connection, String sql) throws SQLException {
